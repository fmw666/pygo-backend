...
const (
	Order_CartItemList_FullMethodName      = "/proto.Order/CartItemList"
	Order_CreateCartItem_FullMethodName    = "/proto.Order/CreateCartItem"
	Order_UpdateCartItem_FullMethodName    = "/proto.Order/UpdateCartItem"
	Order_DeleteCartItem_FullMethodName    = "/proto.Order/DeleteCartItem"
...
type OrderClient interface {
	CartItemList(ctx context.Context, in *UserInfoRequest, opts ...grpc.CallOption) (*CartItemListResponse, error)
...
func (c *orderClient) CartItemList(ctx context.Context, in *UserInfoRequest, opts ...grpc.CallOption) (*CartItemListResponse, error) {
...
type OrderServer interface {
	CartItemList(context.Context, *UserInfoRequest) (*CartItemListResponse, error)
...
func (UnimplementedOrderServer) CartItemList(context.Context, *UserInfoRequest) (*CartItemListResponse, error) {
...
func _Order_CartItemList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).CartItemList(ctx, req.(*UserInfoRequest))
	}
