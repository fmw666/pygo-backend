...
from grpc import StatusCode, RpcError, UnaryStreamClientInterceptor, UnaryUnaryClientInterceptor
    ...
    def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        while True:
            try:
                ...
                if e.code() not in self.retry_codes or retry_count >= self.max_retries:
                    raise e
                retry_count += 1
